...
public class ApplicationParameterDAOImpl implements ApplicationParameterDAO {
    ...
    public void insert(ApplicationParameter parameter) {
        ...
        // ✅ CORRECT: Utilisation de try-with-resources
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Erreur lors de l'insertion du paramètre: " + e.getMessage(), e);
        }
        // ✅ La connexion est automatiquement fermée (retournée au pool)
    }
    ...
    public void update(ApplicationParameter parameter) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Erreur lors de la mise à jour du paramètre: " + e.getMessage(), e);
        }
    }
    ...
    public void delete(String parameterKey) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Erreur lors de la suppression du paramètre: " + e.getMessage(), e);
        }
    }
    ...
    public ApplicationParameter findByKey(String parameterKey) {
        ...
        // ✅ CORRECT: try-with-resources pour TOUTES les ressources
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            throw new RuntimeException("Erreur lors de la recherche du paramètre: " + e.getMessage(), e);
        }
    ...
    public List<ApplicationParameter> findByCategory(String category) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Erreur lors du chargement des paramètres par catégorie: " + e.getMessage(), e);
        }
    ...
    public Map<String, String> getAllAsMap() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Erreur lors du chargement des paramètres en map: " + e.getMessage(), e);
        }
    ...
    public boolean existsByKey(String parameterKey) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            throw new RuntimeException("Erreur lors de la vérification du paramètre: " + e.getMessage(), e);
        }
