...
public class ProductService {
    ...
    public List<Product> getProductsWithPagination(int page, int pageSize, String search, String category, String status) {
        int offset = (page - 1) * pageSize;
        return productDAO.getProductsWithPagination(offset, pageSize, search, category, status);
    }

    public long getTotalProducts(String search, String category, String status) {
        return productDAO.getTotalProductsCount(search, category, status);
    }

    public long getActiveProductsCount() {
        return productDAO.getActiveProductsCount();
    }

    public long getPrescriptionProductsCount() {
        return productDAO.getPrescriptionProductsCount();
    }
    ...
    public List<String> getAllDosageForms() {
        return productDAO.getAllDosageForms();
    }
